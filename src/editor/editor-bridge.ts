 ...
 * features (the live-resolving link card and the cross-book picker) depend only
 ...
 * `@/store` imports (Dependency Inversion) and makes the page-link UI testable
 * with a fake bridge.
 */
export interface EditorBridge {
  /** True while the page index / books are still loading. */
  loading: boolean;
