...
const DOCUMENT_META_COLUMNS =
  "id, user_id, book_id, parent_document_id, title, icon, cover_url, cover_position, subtitle, banner_color, banner_text, show_outline, show_subtitle, show_contents, spellcheck_enabled, spellcheck_ignores, is_title_page, position, font_overrides, created_at, updated_at" as const;
