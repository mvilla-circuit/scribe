...
const REMOVE_REVEAL_SHELL =
  "gap-0 transition-[gap,padding] duration-150 ease-out motion-reduce:transition-none group-hover/chip:gap-3 group-hover/chip:pr-3 group-focus-within/chip:gap-3 group-focus-within/chip:pr-3";
